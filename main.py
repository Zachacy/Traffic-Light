...
trainset = LightStatusDataset(classes=classes, root='/home/rvl/Dataset/New_TL/', list_file='train.txt', transform=transform_train)
...
net = alexnet_NIN.AlexNet(num_classes=len(classes))
...
def main():
    ...
    test_single_image(input_path='4.jpg')
